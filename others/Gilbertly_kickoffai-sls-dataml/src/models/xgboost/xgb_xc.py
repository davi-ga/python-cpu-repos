...
def xgboost_xc(sm_client, ssm_client, model_label, model_metric, tuning_job_name, param_prefix):
  """XGBoost binary classification model for the 'xc' label."""
...
def get_hpo_config(sm_client, ssm_client, model_label, model_metric):
  """Return XGBoost hyperparameter tuning config for the 'xc' label."""
...
def start_training():
  """Start XGBoost training for the 'xc' label."""
  pass
